...
def coco2kitti(catNms, annFile):
    ...
    for img in coco.imgs:
        ...
        if len(annIds) > 0:
            ...
            # open text file
            with open('./labels_more-imgs/' + img_fname.split('.')[0] + '.txt','w') as label_file:
...
if __name__ == '__main__':
    ...
    dataDir = 'C:/Users/Matt/OneDrive/Documents/Kettering/Courses/Summer-2019/ce-senior-design/creating-KITTI-datasets/cocosynth-master/datasets/stop_signs_by_hand'#..
    dataType = 'more-imgs'
